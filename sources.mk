...
UTREEXO_LIB_HEADERS_INT += %reldir%/src/crypto/sha256.h
...
UTREEXO_LIB_SOURCES_INT += %reldir%/src/crypto/sha256.cpp
UTREEXO_LIB_SOURCES_INT += %reldir%/src/crypto/sha256_avx2.cpp
UTREEXO_LIB_SOURCES_INT += %reldir%/src/crypto/sha256_shani.cpp
UTREEXO_LIB_SOURCES_INT += %reldir%/src/crypto/sha256_sse4.cpp
UTREEXO_LIB_SOURCES_INT += %reldir%/src/crypto/sha256_sse41.cpp
