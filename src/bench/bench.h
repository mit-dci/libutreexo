...
#ifndef UTREEXO_BENCH_BENCH_H
#define UTREEXO_BENCH_BENCH_H
...
{
    ...do any setup needed...
    tip: use bench.complexityN() to refer to the asymptote value that was
         set through the BenchRunner
